...
.citytag{padding:10px 16px;background:#fff}
  ...
  /* 寻亲轮播（分页展示横幅：顶部"广告位"小字+内容区+底部圆点；每6秒自动翻页，可左右手动切换；纯展示不可点击） */
  ...
  .miss-stage{overflow:hidden;width:100%;position:relative}
  ...
  .miss-card{display:flex;align-items:center;gap:10px;flex:1;min-width:0;cursor:default}
  .miss-ph{width:48px;height:60px;object-fit:cover;border-radius:8px;background:#eee;flex:0 0 auto;border:1px solid var(--line)}
  .miss-txt{display:flex;flex-direction:column;line-height:1.35;min-width:0;flex:1}
  .miss-txt b{color:var(--text);font-size:14px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  .miss-txt span{color:var(--sub);font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  .miss-arrow{position:absolute;top:50%;transform:translateY(-50%);z-index:3;width:26px;height:26px;border-radius:50%;background:rgba(255,255,255,.92);border:1px solid var(--line);color:var(--primary);font-size:16px;line-height:24px;text-align:center;cursor:pointer;user-select:none;box-shadow:0 1px 3px rgba(0,0,0,.12)}
  .miss-prev{left:0}
  .miss-next{right:0}
...
function missBarHTML(){
  ...
  var html = '<div class="missbar">'
    + '<div class="miss-top"><span class="miss-tag">广告位</span><span class="miss-title">宝贝回家寻亲信息 · 纯展示 · 如发现线索请拨打110</span></div>'
    + '<div class="miss-stage">'
    + '<span class="miss-arrow miss-prev">‹</span>'
  ...
  html += '</div></div><span class="miss-arrow miss-next">›</span></div><div class="miss-dots">';
